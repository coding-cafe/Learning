...
class Blockchain:
    def __init__(self):
        ...
        initial_block = self._create_block(
            data="Block 1 (Genesis Block)", proof=1, previous_hash="0", index=1,
        )
...
# Installation: Run Only once when required
# python3 -m venv venv
# pip install "fastapi" ipython

# Step to execute code in "Terminal"
...
# bc.chain
# bc.mine_block("this is a cool blockchain tutorial")
# bc.chain[1]["data"]="Lost world"
# bc.is_check_valid()
